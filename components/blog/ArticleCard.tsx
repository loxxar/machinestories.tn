...
export default function ArticleCard({ article, featured = false }: ArticleCardProps) {
  ...
  if (featured) {
    return (
      <article className="grid md:grid-cols-2 gap-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
        {article.image && (
        ...
        <div className="p-6 flex flex-col justify-center">
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 dark:text-white mb-3 line-clamp-2">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <time dateTime={formatDateISO(article.date)} className="text-sm text-gray-500 dark:text-gray-400">
    ...
    <article>
      <Card hover>
        ...
        <div className="p-5">
          ...
          <h2 className="font-heading text-lg font-bold text-gray-900 dark:text-white mb-2 line-clamp-2">
            <Link href={article.route} className="hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
              {article.title}
            </Link>
          </h2>
