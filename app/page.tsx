    ...
    <>
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-slate-950">
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-slate-500/10 rounded-full blur-[128px]" />
        </div>
        ...
        <Container className="relative z-20 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm">
              ...
              <span className="text-sm text-slate-300">Votre source sur l&apos;IA en français</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Link
                href="/blog"
                className="group px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300"
              >
                Explorer le blog
        ...
        <Container className="relative">
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <p className="text-slate-400">Les contenus les plus importants du moment</p>
            </div>
            <Link href="/blog" className="hidden md:flex items-center gap-2 text-cyan-400 hover:text-cyan-300 transition-colors">
              Voir tous
          ...
          {featuredArticles.length > 0 ? (
            <div className="grid gap-8">
              {featuredArticles.map((article) => (
                <article key={article.slug} className="group relative">
                  <div className="absolute -inset-px bg-gradient-to-r from-cyan-500/50 via-blue-500/50 to-cyan-500/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm" />
                  <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/5 rounded-2xl overflow-hidden group-hover:border-cyan-500/30 transition-colors">
                    <div className="grid md:grid-cols-2 gap-0">
                      ...
                      <div className="p-8 flex flex-col justify-center">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <span className="text-sm text-slate-500">{article.readingTime} min</span>
                        </div>
                        <h3 className="font-heading text-2xl font-bold text-white mb-3 group-hover:text-cyan-300 transition-colors">
            ...
            <div className="text-center py-12">
              <p className="text-slate-400">Aucun article en vedette pour le moment.</p>
            </div>
          )}
        </Container>
      </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {categories.map((cat, index) => (
              <Link
                ...
                className="group relative p-6 bg-slate-900/50 border border-white/5 rounded-2xl hover:border-cyan-500/50 transition-all duration-300 overflow-hidden"
        ...
        <Container>
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <p className="text-slate-400">Les dernières publications sur l&apos;IA</p>
            </div>
            <Link href="/blog" className="hidden md:flex items-center gap-2 text-cyan-400 hover:text-cyan-300 transition-colors">
              Voir tous
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-600 via-blue-600 to-cyan-600" />
        ...
        <Container className="relative text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            ...
            <input
              ...
              required
              className="flex-1 px-6 py-4 rounded-xl text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-4 focus:ring-white/20"
            />
            <button
              type="submit"
              className="px-8 py-4 bg-slate-950 text-white font-semibold rounded-xl hover:bg-slate-900 transition-colors"
            >
              S&apos;inscrire
            </button>
          </form>
