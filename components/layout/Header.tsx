      ...
      <nav className="container mx-auto px-4 h-16 flex items-center justify-between" aria-label="Navigation principale">
        <Link href="/" className="flex items-center gap-3 group" aria-label="Machine Stories - Accueil">
          <div className="relative w-10 h-10">
            <div className="absolute inset-0 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl rotate-3 group-hover:rotate-6 transition-transform duration-300" />
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
              <div className="bg-slate-900 border border-white/10 rounded-xl shadow-2xl py-2 min-w-[200px] backdrop-blur-xl">
                {categories.map((cat) => (
                  <Link
                    key={cat.slug}
          ...
          <Link href="/a-propos" className="text-sm font-medium text-slate-300 hover:text-white transition-colors">
            À propos
          </Link>
  ...
  return (
    <div className="md:hidden relative group">
      ...
      <div className="absolute right-0 top-full pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
        <div className="bg-slate-900 border border-white/10 rounded-xl shadow-2xl py-2 min-w-[200px]">
          <Link href="/blog" className="block px-4 py-2 text-sm text-slate-300 hover:text-white">
            Blog
          </Link>
          ...
          <div className="border-t border-white/10 my-1" />
          <Link href="/a-propos" className="block px-4 py-2 text-sm text-slate-300 hover:text-white">
            À propos
          </Link>
          <Link href="/contact" className="block px-4 py-2 text-sm text-slate-300 hover:text-white">
            Contact
          </Link>
        </div>
      </div>
